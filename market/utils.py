...
def upload_product_to_dribble(product, title, description, tags, image):
    ...
    time.sleep(5)
    driver.find_element(By.XPATH, "/html/body/div[1]/div[2]/div/div[2]/div/div[2]/div/label/input").send_keys(r'C:\Users\faddy\Downloads\01.png') # Upload Image
    time.sleep(5) # sleep to fully upload image
